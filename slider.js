...
const text2_options = [
  ...
  "Lorem ipsum dolor sit amet consectetur adipisicing elit",
  "Lorem ipsum dolor sit amet consectetur adipisicing elit",
  "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Deleniti, natus quos mollitia, odio provident ipsam consequuntur repellendus praesentium facilis perferendis voluptate, placeat quo. Ratione culpa odio ullam quos ut quidem!"
];
...
let input_name = document.querySelector('.review__input-name'),
    input_text = document.querySelector('.review__input-text'),
    btnInput = document.querySelector('.btnInput');

btnInput.addEventListener('click', () => {

        if (input_name.value && input_text.value) {
          text1_options.push(input_name.value);
          text2_options.push(input_text.value);
          input_name.value = '';
          input_text.value = '';
          alert('Review sent');
        } else {
